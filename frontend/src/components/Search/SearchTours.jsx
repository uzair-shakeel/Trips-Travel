    ...
    <div>
      ...
      <div className="container text-center">
        ...
        <div className="max-w-[570px] mt-[15px] mx-auto bg-gray-100  rounded-md flex items-center justify-between">
          <input type="search" ref={cityRef} className='py-4 pl-4 bg-transparent w-full focus:outline-none  placeholder:text-TextColor' placeholder='Search Doctor' />
          <button onClick={SubmitHandler}  className="Searchbtn mt-0 rounded-[0px] rounded-r-md mx-2 hover:px-6">Search</button>
        </div>
      </div>
    </section>
