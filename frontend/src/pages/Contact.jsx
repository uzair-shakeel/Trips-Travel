...
const Contact = () => {
  return (
    <section>
      <div className='px-4 mx-auto min-h-screen max-w-screen-md'>
        ...
        <form action="#" className='space-y-4'>
          ...
          <div>
            ...
            <textarea type='text' id="message"  rows="2" placeholder='Leave a Message...' className='form_input mt-1'></textarea>
          </div>
